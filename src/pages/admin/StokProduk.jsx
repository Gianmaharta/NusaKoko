                    ...
                    <tr key={p.id} style={{ background: i % 2 === 0 ? '#f5e7d6' : '#e9dbc7' }}>
                      ...
                      <td style={{ padding: 10, border: '1px solid #4E342E', textAlign: 'center', minWidth: 90 }}>
                        <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                          {/* Tombol Edit */}
                          <button
                            style={{ background: '#7ba05b', border: 'none', borderRadius: 12, width: 48, height: 48, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: 0 }}
                            title="Edit"
                          ...
                          {/* Tombol Delete */}
                          <button
                            style={{ background: '#e53935', border: 'none', borderRadius: 12, width: 48, height: 48, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: 0 }}
                            title="Hapus"
